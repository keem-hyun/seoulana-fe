			...
			<div className="container mx-auto px-4 py-8">
				...
				<div className="flex justify-between items-center mb-8">
					<div className="flex items-center gap-4">
						<h1 className="text-4xl font-extrabold uppercase tracking-wider text-transparent bg-clip-text bg-gradient-to-r from-[#5fb3ff] to-purple-500 dark:from-[#4a9ce8] dark:to-purple-400">
							MEME COMMUNITIES
						</h1>
						{user && (
							<button
								onClick={() => setIsCreateDialogOpen(true)}
								className="flex items-center gap-2 bg-[#5fb3ff] hover:bg-[#4a9ce8] text-white px-5 py-3 border-4 border-dashed border-white dark:border-gray-700 rounded-full text-sm font-extrabold transition-all transform hover:scale-105 shadow-lg"
							>
				...
				<div className="flex-1">
					{/* 커뮤니티 목록 직접 표시 */}
					<div className="bg-white dark:bg-gray-800 border-4 border-dashed border-[#5fb3ff] dark:border-[#4a9ce8] p-8 rounded-xl shadow-xl">
						<div className="mb-6 flex items-center">
							<span className="w-8 h-8 bg-[#5fb3ff] rounded-full mr-3"></span>
							<h2 className="text-3xl font-extrabold tracking-widest uppercase mb-0 text-[#5fb3ff] dark:text-[#5fb3ff]">
								Trending Meme Communities
							</h2>
							<span className="w-8 h-8 bg-[#5fb3ff] rounded-full ml-3"></span>
						</div>
						...
						{communityLoading ? (
							...
							<div className="text-center py-12">
								...
								<p className="text-lg text-[#5fb3ff] dark:text-[#5fb3ff] font-extrabold">
